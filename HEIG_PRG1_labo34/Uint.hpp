...
public:
    ...
    /** @brief Calculates the greatest common divizor of 2 Uint
     * @details Algorithm: https://en.wikipedia.org/wiki/Euclidean_algorithm
     * @param a The first number
     * @param b  The second number
     * @return The GCD of a and b*/
    friend Uint gcd(Uint a, Uint b);
    ...
    friend int cmp(const Uint &left, const Uint &right);
